...
const TRACE = [
  ...
  { tok: "s2.subtask[3]",       val: "grasp · bottle",                skill: null },
  { tok: "s2.subtask[4]",       val: "locate glass · pour",           skill: null },
  { tok: "s2.subtask[5]",       val: "return bottle → fridge",        skill: null },
  { tok: "s2.subtask[6]",       val: "recall glass · navigate user",  skill: null },
  { tok: "s2.subtask[7]",       val: "handover · glass",              skill: null },
  // Navigate to kitchen
  { tok: "recall",              val: "kitchen → pose (12.3, 4.1) ✓", skill: "recall", ok: true },
  ...
  // Deliver to user
  { tok: "recall",              val: "glass → countertop · pose ✓",   skill: "recall", ok: true },
  { tok: "ExecuteRSkill",       val: "navigate_to_pose · countertop", skill: "navigate" },
  { tok: "ExecuteRSkill",       val: 'grasp("glass")',                 skill: "grasp" },
  { tok: "recall",              val: "user → pose (0.0, 0.0) ✓",      skill: "recall", ok: true },
